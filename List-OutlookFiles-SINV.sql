...
SF.FileName, UPPER( right(SF.FileName,3)) as Extension,
...
--where CollectionID='STG0030A' -- All Systems Domain IE
 where SF.FileName like 'OUTLOOK.exe' and CollectionID='STG0073C' --and SF.Filepath like 'C:\documents and settings\%'
--where SF.FileName like '%.exe' and CollectionID='STG0073C' --and SF.Filepath like 'C:\documents and settings\%'

--and SYS.Name0 = 'tcie158'

Order by SYS.Name0, SF.FileName
