SELECT DISTINCT  
	...
	OUTER APPLY (SELECT TOP 1 * from v_RA_System_IPSubnets IPSub where IPSub.ResourceID = SYS.resourceID) IPSub
	LEFT JOIN vSMS_Boundary BDY on IPSub.IP_Subnets0 = BDY.Value
	
	 WHERE (GSSYS.SystemRole0 LIKE 'Server') and (SYS.Name0 like 'FFF%' or sys.Name0 like '%tobin%') 
