...
FROM         dbo.v_GS_SYSTEM INNER JOIN
                      ...
                      dbo.v_GS_LOGICAL_DISK ON dbo.v_GS_SYSTEM.ResourceID = dbo.v_GS_LOGICAL_DISK.ResourceID 
                      LEFT  JOIN dbo.v_GS_FFF0 AS vFFF ON dbo.v_GS_SYSTEM.ResourceID = vFFF.ResourceID
WHERE     (dbo.v_GS_SYSTEM.SystemRole0 LIKE 'server') and v_GS_LOGICAL_DISK.VolumeName0 IS NOT NULL


GROUP BY dbo.v_GS_SYSTEM.Name0 --,v_GS_LOGICAL_DISK.Size0
/*, dbo.v_GS_OPERATING_SYSTEM.Description0, dbo.v_GS_OPERATING_SYSTEM.Caption0, 
