...
#Variable qui permet d'exclure un lot spécifique, comme par exemple le déploiement en cours. (2016-03-08)
$SUGExcluded = '2016-03-08'
...
$SUGSourceList = (Get-CMSoftwareUpdateGroup | Where-Object -FilterScript {( $_.LocalizedDisplayName -like $SUGFilter ) -and ( $_.IsDeployed -eq $true ) -and ( $_.LocalizedDisplayName -notMatch $SUGExcluded )})
