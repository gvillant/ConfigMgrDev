...
26/08/2015	Gaëtan VILLANT @ Dell
...
SET @CollectionID = 'FFF0034A' --'FFF002D2'
--*/
...
CASE 
	...
	CHS.LastActiveTime AS [Dernière Activité],
...
CASE 
	...
	LEFT JOIN v_GS_FFF0 vFFF on SYS.ResourceID = vFFF.ResourceID
