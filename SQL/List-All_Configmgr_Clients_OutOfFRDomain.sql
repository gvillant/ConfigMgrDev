SELECT DISTINCT 
SYS.Netbios_Name0 as Name,MAX (BDY.DisplayName) as Location,  sys.SMS_UUID_Change_Date0, 
...
WHERE SYS.Obsolete0 = 0 AND (LDISK.DeviceID0 IS NULL or LDISK.DeviceID0 = 'C:') and sys.Resource_Domain_OR_Workgr0 <> 'STAGO'
--AND FCM.CollectionID = 'SMS00004' 
 
GROUP BY SYS.Netbios_Name0, sys.SMS_UUID_Change_Date0, SYS.Obsolete0,SYS.Resource_Domain_OR_Workgr0,  SYS.Operating_System_Name_and0,
...
ORDER BY  location,sys.SMS_UUID_Change_Date0,  SYS.Netbios_Name0, OPSYS.InstallDate0 DESC