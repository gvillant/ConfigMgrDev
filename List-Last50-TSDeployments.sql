SELECT  TOP 50 ( SYS.Netbios_Name0) as Name,SYS.Is_Assigned_To_User0 as IsAssignedToUser, 
...
STA.Version0 as Version, STA.SMSTSPackageID0 as PackageID, STA.SMSTSAdvertID0 as AdvertID, STA.SMSTSLaunchMode0 as LaunchMode,

CASE WHEN STA.SMSTSMediaType0 = ' _SMSTSMediaType ' THEN STA.SMSTSLaunchMode0 ELSE STA.SMSTSMediaType0 END as MediaType,

STA.SMSTSPackageName0 as PackageName
...
GROUP BY SYS.Netbios_Name0,SYS.Is_Assigned_To_User0 , SYS.Obsolete0,SYS.Resource_Domain_OR_Workgr0,  SYS.Operating_System_Name_and0,
...
STA.Version0, STA.SMSTSPackageID0, STA.SMSTSAdvertID0, STA.SMSTSLaunchMode0,STA.SMSTSMediaType0,STA.SMSTSPackageName0

ORDER BY OPSYS.InstallDate0 DESC,SYS.Netbios_Name0